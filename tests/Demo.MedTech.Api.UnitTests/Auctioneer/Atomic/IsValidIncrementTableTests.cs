...
namespace Demo.MedTech.Api.UnitTests.Auctioneer.Atomic
{
    public class IsValidIncrementTableTests
    {
        ...
        public void Given_increment_table_is_invalid_When_is_valid_increment_table_is_passed_Then_should_return_validation_error(List<Increment> increments, string[] expectedDescriptionKey)
        {
            ...
            AuctioneerContext auctioneerContextContext = new AuctioneerContext(CommonUtilities.CreateLotDetailString(1, 11, 35, 100, 1, "UTC", 60, null, increments), _requestPipe, _rules, _transformRules);
