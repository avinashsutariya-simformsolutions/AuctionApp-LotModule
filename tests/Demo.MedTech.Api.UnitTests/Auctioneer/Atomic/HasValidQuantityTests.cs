...
namespace Demo.MedTech.Api.UnitTests.Auctioneer.Atomic
{
    public class HasValidQuantityTests
    {
        ...
        {
            //Arrange
            var auctioneerContext = new AuctioneerContext(CommonUtilities.CreateLotDetailString(AuctionId, LotId, openingPrice, buyItNow, quantity, timeZone, extensionTimeInSeconds),_requestPipe, _rules, _transformRules);
